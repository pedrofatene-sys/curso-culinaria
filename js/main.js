...
const channels = [
    { id: 'SeDXen3LqrA', name: 'Arroz Solto' },
    { id: 'gJsOax98g2g', name: 'Feijão Com Caldo Grosso' },
    { id: '0koTcEAolVM', name: 'Macarrão à Bolonhesa' },
    { id: 'Q5T0kVC90W0', name: 'Receita de Strogonoff' },
    { id: 'MFnihol7UPM', name: 'Cachorro Quente Cremoso' },
    { id: 'A2Evu2HVlSE', name: 'Ensopado de Frango' },
    { id: '9RP3Lm-fYN8', name: 'Feijão Tropeiro - super SIMPLES e FÁCIL' },
    { id: 'NTwUoyMaPKc', name: 'Frango Recheado' },
    { id: 'YE3uCFQ4IBE', name: 'Como Amolar Facas' },
    { id: 'VLmFjRKaf_Y', name: 'CORTES PROFISSONAIS - CISELER | JULIENNE | BRUNOISE | MACEDÔNIA' },
    { id: 'AIzAaEGZ-jc', name: 'Macarronese - Simples, Prático e DELICIOSO!' },
    { id: 'AcHTPM624e4', name: 'Molho Barbecue' },
    { id: '55x8iW0ahUU', name: 'Costelinha Australiana - COSTELA DO Outback' }
];
